...
> Use the `conditional_effects` function from `brm` to plot predicted probabilities by Gender and Age across each rank. This is just to highlight an easy way to plot data using the `brms` package.
